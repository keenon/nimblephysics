...
class World():
    ...
    def loadSkeleton(self, path: str, basePosition: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.]), baseEulerAnglesXYZ: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.])) -> _nimblephysics.dynamics.Skeleton: ...
    def positionsToJson(self) -> str: ...
    def removeAllSimpleFrames(self) -> typing.Set[_nimblephysics.dynamics.SimpleFrame]: ...
    def removeAllSkeletons(self) -> typing.Set[_nimblephysics.dynamics.Skeleton]: ...
    ...
    def toJson(self) -> str: ...
    def tuneMass(self, arg0: _nimblephysics.dynamics.BodyNode, arg1: _nimblephysics.neural.WrtMassBodyNodeEntryType, arg2: numpy.ndarray[numpy.float64, _Shape[m, 1]], arg3: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None: ...
    pass
