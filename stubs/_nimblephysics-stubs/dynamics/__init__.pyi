...
class AxisOrder():
    ...
    pass
class SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties(nimblephysics_libs._nimblephysics.common.Composite):
    def __init__(self) -> None: ...
    pass
...
class ContactInverseDynamicsResult():
    ...
    def vel(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    pass
class RequiresAspect_EmbeddedPropertiesAspect_Joint_JointProperties(SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties, nimblephysics_libs._nimblephysics.common.Composite):
    def __init__(self) -> None: ...
    pass
class EmbedProperties_Joint_JointProperties(RequiresAspect_EmbeddedPropertiesAspect_Joint_JointProperties, SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties, nimblephysics_libs._nimblephysics.common.Composite):
    pass
...
class RequiresAspect_EmbeddedStateAndPropertiesAspect_GenericJoint_R3_GenericJointState_GenericJointUniqueProperties(SpecializedForAspect_EmbeddedStateAndPropertiesAspect_GenericJoint_R3_GenericJointState_GenericJointUniqueProperties, nimblephysics_libs._nimblephysics.common.Composite):
    def __init__(self) -> None: ...
    pass
class Joint(nimblephysics_libs._nimblephysics.common.Subject, EmbedProperties_Joint_JointProperties, RequiresAspect_EmbeddedPropertiesAspect_Joint_JointProperties, SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties, nimblephysics_libs._nimblephysics.common.Composite):
    class ActuatorType():
        """
        Members:
...
class VisualAspectProperties():
    pass
class ZeroDofJoint(Joint, nimblephysics_libs._nimblephysics.common.Subject, EmbedProperties_Joint_JointProperties, RequiresAspect_EmbeddedPropertiesAspect_Joint_JointProperties, SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties, nimblephysics_libs._nimblephysics.common.Composite):
    def computePotentialEnergy(self) -> float: ...
    def getAcceleration(self, index: int) -> float: ...
    def getAccelerationLowerLimit(self, index: int) -> float: ...
    def getAccelerationLowerLimits(self) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
...
class WeldJointProperties():
    pass
class WeldJoint(ZeroDofJoint, Joint, nimblephysics_libs._nimblephysics.common.Subject, EmbedProperties_Joint_JointProperties, RequiresAspect_EmbeddedPropertiesAspect_Joint_JointProperties, SpecializedForAspect_EmbeddedPropertiesAspect_Joint_JointProperties, nimblephysics_libs._nimblephysics.common.Composite):
    @staticmethod
    def getStaticType() -> str: ...
    def getType(self) -> str: ...
