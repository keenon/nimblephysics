...
class GUIStateMachine():
    ...
    def clear(self) -> None: ...
    def clearBodyWrench(self, body: _nimblephysics.dynamics.BodyNode, prefix: str = 'wrench') -> None: ...
    ...
    def createMeshFromShape(self, key: str, mesh: _nimblephysics.dynamics.MeshShape, pos: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.]), euler: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.]), scale: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([1., 1., 1.]), color: numpy.ndarray[numpy.float64, _Shape[4, 1]] = array([0.5, 0.5, 0.5, 1. ]), layer: str = '', castShadows: bool = True, receiveShadows: bool = False) -> None: ...
    ...
    def renderBodyWrench(self, body: _nimblephysics.dynamics.BodyNode, wrench: numpy.ndarray[numpy.float64, _Shape[6, 1]], scaleFactor: float = 0.1, prefix: str = 'wrench', layer: str = '') -> None: ...
    def renderMovingBodyNodeVertices(self, body: _nimblephysics.dynamics.BodyNode, scaleFactor: float = 0.1, prefix: str = 'vert-vel', layer: str = '') -> None: ...
    def renderSkeleton(self, skeleton: _nimblephysics.dynamics.Skeleton, prefix: str = 'world', overrideColor: numpy.ndarray[numpy.float64, _Shape[4, 1]] = array([-1., -1., -1., -1.]), layer: str = '') -> None: ...
    def renderTrajectoryLines(self, world: _nimblephysics.simulation.World, positions: numpy.ndarray[numpy.float64, _Shape[m, n]], prefix: str = 'trajectory', layer: str = '') -> None: ...
    def renderWorld(self, world: _nimblephysics.simulation.World, prefix: str = 'world', renderForces: bool = True, renderForceMagnitudes: bool = True, layer: str = '') -> None: ...
