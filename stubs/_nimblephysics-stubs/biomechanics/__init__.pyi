...
class Anthropometrics():
    ...
    def getGradientOfLogPDFWrtBodyScales(self, skel: _nimblephysics.dynamics.Skeleton) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getGradientOfLogPDFWrtGroupScales(self, skel: _nimblephysics.dynamics.Skeleton) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
...
class BatchGaitInverseDynamics():
    ...
    def getContactBodiesAtTimestep(self, timestep: int) -> typing.List[_nimblephysics.dynamics.BodyNode]: ...
...
class ContactRegimeSection():
    ...
    def endTime(self, arg0: int) -> None:
        pass
    @property
    def groundContactBodies(self) -> typing.List[_nimblephysics.dynamics.BodyNode]:
        """
        :type: typing.List[_nimblephysics.dynamics.BodyNode]
        """
    @groundContactBodies.setter
    def groundContactBodies(self, arg0: typing.List[_nimblephysics.dynamics.BodyNode]) -> None:
        pass
    @property
...
class DynamicsFitter():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, footNodes: typing.List[_nimblephysics.dynamics.BodyNode], trackingMarkers: typing.List[str]) -> None: ...
    ...
    @staticmethod
    @typing.overload
    def createInitialization(skel: _nimblephysics.dynamics.Skeleton, kinematicInits: typing.List[MarkerInitialization], trackingMarkers: typing.List[str], grfNodes: typing.List[_nimblephysics.dynamics.BodyNode], forcePlateTrials: typing.List[typing.List[ForcePlate]], framesPerSecond: typing.List[int], markerObservationTrials: typing.List[typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]) -> DynamicsInitialization: ...
    @staticmethod
    @typing.overload
    def createInitialization(skel: _nimblephysics.dynamics.Skeleton, markerMap: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], trackingMarkers: typing.List[str], grfNodes: typing.List[_nimblephysics.dynamics.BodyNode], forcePlateTrials: typing.List[typing.List[ForcePlate]], poseTrials: typing.List[numpy.ndarray[numpy.float64, _Shape[m, n]]], framesPerSecond: typing.List[int], markerObservationTrials: typing.List[typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]) -> DynamicsInitialization: ...
...
class DynamicsInitialization():
    ...
    def bodyMasses(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def contactBodies(self) -> typing.List[typing.List[_nimblephysics.dynamics.BodyNode]]:
        """
        :type: typing.List[typing.List[_nimblephysics.dynamics.BodyNode]]
        """
    @contactBodies.setter
    def contactBodies(self, arg0: typing.List[typing.List[_nimblephysics.dynamics.BodyNode]]) -> None:
        pass
    @property
    ...
    def grfBodyIndices(self, arg0: typing.List[int]) -> None:
        pass
    @property
    def grfBodyNodes(self) -> typing.List[_nimblephysics.dynamics.BodyNode]:
        """
        :type: typing.List[_nimblephysics.dynamics.BodyNode]
        """
    @grfBodyNodes.setter
    def grfBodyNodes(self, arg0: typing.List[_nimblephysics.dynamics.BodyNode]) -> None:
        pass
    @property
    ...
    def jointWeights(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def joints(self) -> typing.List[_nimblephysics.dynamics.Joint]:
        """
        :type: typing.List[_nimblephysics.dynamics.Joint]
        """
    @joints.setter
    def joints(self, arg0: typing.List[_nimblephysics.dynamics.Joint]) -> None:
        pass
    @property
    ...
    def trialTimesteps(self, arg0: typing.List[float]) -> None:
        pass
    @property
    def updatedMarkerMap(self) -> typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @updatedMarkerMap.setter
    def updatedMarkerMap(self, arg0: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    pass
class ForcePlate():
    @property
...
class Frame():
    ...
    pass
class IKErrorReport():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, markers: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], poses: numpy.ndarray[numpy.float64, _Shape[m, n]], observations: typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
...
class InitialMarkerFitParams():
    ...
    def setJointCenters(self, joints: typing.List[_nimblephysics.dynamics.Joint], jointCenters: numpy.ndarray[numpy.float64, _Shape[m, n]], jointAdjacentMarkers: typing.List[typing.List[str]]) -> InitialMarkerFitParams: ...
    def setJointCentersAndWeights(self, joints: typing.List[_nimblephysics.dynamics.Joint], jointCenters: numpy.ndarray[numpy.float64, _Shape[m, n]], jointAdjacentMarkers: typing.List[typing.List[str]], jointWeights: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> InitialMarkerFitParams: ...
...
class LabelledMarkers():
    ...
    pass
class LilypadSolver():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, groundContactBodies: typing.List[_nimblephysics.dynamics.BodyNode], groundNormal: numpy.ndarray[numpy.float64, _Shape[3, 1]], tileSize: float) -> None: ...
    def clear(self) -> None: ...
    def debugToGUI(self, gui: _nimblephysics.server.GUIWebsocketServer) -> None: ...
    def getContactBodies(self) -> typing.List[_nimblephysics.dynamics.BodyNode]: ...
    ...
    pass
class MarkerFitter():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, markers: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], ignoreVirtualJointCenterMarkers: bool = False) -> None: ...
...
class NeuralMarkerLabeller(MarkerLabeller):
    ...
    pass
class OpenSimFile():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, markers: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    @property
    ...
    def jointsDrivenBy(self, arg0: typing.List[typing.Tuple[str, str]]) -> None:
        pass
    @property
    def markersMap(self) -> typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markersMap.setter
    def markersMap(self, arg0: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def skeleton(self) -> _nimblephysics.dynamics.Skeleton:
        """
        :type: _nimblephysics.dynamics.Skeleton
        """
    @skeleton.setter
    def skeleton(self, arg0: _nimblephysics.dynamics.Skeleton) -> None:
        pass
    @property
    def trackingMarkers(self) -> typing.List[str]:
        """
...
class OpenSimScaleAndMarkerOffsets():
    ...
    def markerOffsets(self, arg0: typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def markers(self) -> typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markers.setter
    def markers(self, arg0: typing.Dict[str, typing.Tuple[_nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def success(self) -> bool:
        """
...
class ResidualForceHelper():
    def __init__(self, skeleton: _nimblephysics.dynamics.Skeleton, forceBodies: typing.List[int]) -> None: ...
    ...
    def calculateResidualJacobianWrt(self, q: numpy.ndarray[numpy.float64, _Shape[m, 1]], dq: numpy.ndarray[numpy.float64, _Shape[m, 1]], ddq: numpy.ndarray[numpy.float64, _Shape[m, 1]], forcesConcat: numpy.ndarray[numpy.float64, _Shape[m, 1]], wrt: _nimblephysics.neural.WithRespectTo) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    ...
    def calculateResidualNormGradientWrt(self, q: numpy.ndarray[numpy.float64, _Shape[m, 1]], dq: numpy.ndarray[numpy.float64, _Shape[m, 1]], ddq: numpy.ndarray[numpy.float64, _Shape[m, 1]], forcesConcat: numpy.ndarray[numpy.float64, _Shape[m, 1]], wrt: _nimblephysics.neural.WithRespectTo, torquesMultiple: float, useL1: bool = False) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    pass
class SkeletonConverter():
    ...
    def getSourceJoints(self) -> typing.List[_nimblephysics.dynamics.Joint]: ...
    def getTargetJointWorldPositions(self) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getTargetJoints(self) -> typing.List[_nimblephysics.dynamics.Joint]: ...
...
class SubjectOnDisk():
    ...
    def getCustomValueDim(self, customValue: str) -> int: ...
