...
class SubjectOnDiskPassHeader():
    def __init__(self) -> None: ...
    def setOpenSimFileText(self, openSimFileText: str) -> SubjectOnDiskPassHeader: ...
    def setProcessingPassType(self, type: ProcessingPassType) -> SubjectOnDiskPassHeader: ...
    pass
class SubjectOnDiskTrial():
    ...
    def addPass(self) -> SubjectOnDiskTrialPass: 
        ...
        """
    def setAccObservations(self, accObservations: typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> SubjectOnDiskTrial: ...
    def setCustomValues(self, customValues: typing.List[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> SubjectOnDiskTrial: ...
    def setEmgObservations(self, emgObservations: typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]) -> SubjectOnDiskTrial: ...
    def setExoTorques(self, exoTorques: typing.Dict[int, numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> SubjectOnDiskTrial: ...
    def setForcePlates(self, forcePlates: typing.List[ForcePlate]) -> SubjectOnDiskTrial: ...
    def setGyroObservations(self, gyroObservations: typing.List[typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> SubjectOnDiskTrial: ...
    def setMarkerNamesGuessed(self, markersGuessed: bool) -> SubjectOnDiskTrial: ...
...
class SubjectOnDiskTrialPass():
    def __init__(self) -> None: ...
    def setAccs(self, accs: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setAngularResidual(self, angularResidual: typing.List[float]) -> SubjectOnDiskTrialPass: ...
    def setComAccs(self, accs: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setComPoses(self, poses: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setComVels(self, vels: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setDofAccelerationFiniteDifferenced(self, dofAccelerationFiniteDifference: typing.List[bool]) -> SubjectOnDiskTrialPass: ...
    def setDofPositionsObserved(self, dofPositionsObserved: typing.List[bool]) -> SubjectOnDiskTrialPass: ...
    def setDofVelocitiesFiniteDifferenced(self, dofVelocitiesFiniteDifferenced: typing.List[bool]) -> SubjectOnDiskTrialPass: ...
    def setGroundBodyCopTorqueForce(self, copTorqueForces: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setGroundBodyWrenches(self, wrenches: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setLinearResidual(self, linearResidual: typing.List[float]) -> SubjectOnDiskTrialPass: ...
    def setMarkerMax(self, markerMax: typing.List[float]) -> SubjectOnDiskTrialPass: ...
    def setMarkerRMS(self, markerRMS: typing.List[float]) -> SubjectOnDiskTrialPass: ...
    def setPoses(self, poses: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setTaus(self, taus: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setType(self, type: ProcessingPassType) -> SubjectOnDiskTrialPass: ...
    def setVels(self, vels: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    pass
forceDiscrepancy: nimblephysics_libs._nimblephysics.biomechanics.MissingGRFReason # value = <MissingGRFReason.forceDiscrepancy: 4>
measuredGrfZeroWhenAccelerationNonZero: nimblephysics_libs._nimblephysics.biomechanics.MissingGRFReason # value = <MissingGRFReason.measuredGrfZeroWhenAccelerationNonZero: 1>
missingBlip: nimblephysics_libs._nimblephysics.biomechanics.MissingGRFReason # value = <MissingGRFReason.missingBlip: 7>
