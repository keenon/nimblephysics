...
ConstantCurveJoint::ConstantCurveJoint(
  ...
  : GenericJoint<math::RealVectorSpace<4>>(props),
    ...
    mNeutralPos(Eigen::Vector4s::Unit(3))
{
}
...
//==============================================================================
void ConstantCurveJoint::setAxisOrder(
...
//==============================================================================
EulerJoint::AxisOrder ConstantCurveJoint::getAxisOrder() const
{
  return mAxisOrder;
}
    ...
    const Eigen::Vector4s& rawPos) const
{
  ...
  if (sinTheta < 0.001)
  {
    ...
    J.block<3, 1>(3, 3) = bentRod.translation().normalized();
  }
  else
  {
    // Compute the bend as a function of the angle from vertical
