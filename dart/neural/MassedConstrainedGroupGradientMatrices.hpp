...
#ifndef DART_NEURAL_MASSED_CONSTRAINT_MATRICES_HPP_
#define DART_NEURAL_MASSED_CONSTRAINT_MATRICES_HPP_
...
class MassedConstrainedGroupGradientMatrices
  : public ConstrainedGroupGradientMatrices
{
public:
  MassedConstrainedGroupGradientMatrices(
