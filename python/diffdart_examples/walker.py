...
def main():
  ...
  rootJoint.setControlForceUpperLimit(2, 0)
  rootJoint.setControlForceLowerLimit(2, 0)
  rootJoint.setControlForceUpperLimit(3, 0)
  rootJoint.setControlForceLowerLimit(3, 0)
  rootJoint.setControlForceUpperLimit(4, 0)
  rootJoint.setControlForceLowerLimit(4, 0)
  rootJoint.setControlForceUpperLimit(5, 0)
  rootJoint.setControlForceLowerLimit(5, 0)
