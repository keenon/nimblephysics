...
TEST(EulerFreeJoint, Construct)
{
  ...
  std::vector<EulerJoint::AxisOrder> orders;
  orders.push_back(EulerJoint::AxisOrder::XYZ);
  orders.push_back(EulerJoint::AxisOrder::XZY);
  orders.push_back(EulerJoint::AxisOrder::ZXY);
